                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-body-small font-medium">
                              {t('sessions.sessionOn')} {session.message_timestamp
                                ? new Date(session.message_timestamp).toLocaleDateString(i18n.language === 'zh-CN' ? 'zh-CN' : 'en-US', {
                                  month: 'short',
                                  day: 'numeric',
                                  year: 'numeric'
                                })
                                : new Date(session.created_at * 1000).toLocaleDateString(i18n.language === 'zh-CN' ? 'zh-CN' : 'en-US', {
                                  month: 'short',
                                  day: 'numeric',
                                  year: 'numeric'
                                })
